...
for lu_no in range(len(lum_tau)):
    ...
    if(lu_no<2): Whether_Hybrid=True
    else: Whether_Hybrid=False
    ...
    if(Whether_Hybrid):
            command_run = "combine -M HybridNew W_Combined.txt --cl 0.9 -t -1 --rMin 0.0 --rMax 1.0 --rAbsAcc=0.001 --expectedFromGrid=0.025  > out1.txt"
            os.system(command_run)
            command_run = "combine -M HybridNew W_Combined.txt --cl 0.9 -t -1 --rMin 0.0 --rMax 1.0 --rAbsAcc=0.001 --expectedFromGrid=0.16  > out2.txt"
            os.system(command_run)
            command_run = "combine -M HybridNew W_Combined.txt --cl 0.9 -t -1 --rMin 0.0 --rMax 1.0 --rAbsAcc=0.001 --expectedFromGrid=0.5  > out3.txt"
            os.system(command_run)
            command_run = "combine -M HybridNew W_Combined.txt --cl 0.9 -t -1 --rMin 0.0 --rMax 1.0 --rAbsAcc=0.001 --expectedFromGrid=0.84  > out4.txt"
            os.system(command_run)
            command_run = "combine -M HybridNew W_Combined.txt --cl 0.9 -t -1 --rMin 0.0 --rMax 1.0 --rAbsAcc=0.001 --expectedFromGrid=0.975  > out5.txt"
            os.system(command_run)
